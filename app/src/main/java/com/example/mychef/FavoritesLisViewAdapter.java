...
public class FavoritesLisViewAdapter extends BaseAdapter {
    ...
    public FavoritesLisViewAdapter(Context context, ArrayList<Recipe> recipes){
        ...
        Log.i("Favourite adapter size:", ":" + recipes.size());
    }
    ...
    static class ViewHolder{
        ...
        public TextView TitleText, authorText, userName, likeNumber;
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null){
            ...
            holder.icon = (ImageView) convertView.findViewById(R.id.profile_image);
        ...
        ref.child("User").child(recipes.get(position).getAuthorUid()).addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                if(userInfo.getUserIcon() != null){
                    Glide.with(finalHolder.icon.getContext()).load(userInfo.getUserIcon()).into(finalHolder.icon);
                }
                //if not use default
                else{
                    finalHolder.icon.setImageResource(R.drawable.usericon);
                }
            }
            @Override
